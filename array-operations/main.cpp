...
int A[]={1,-2,3,200,5,6,7}; // values range [-254..255]
int B[]={2,-3,4,200,6,7,8}; // values range [-254..255]
int C[]={3,4,5,6,7,8,9}; // values range [-254..255]
int D[]={1,3,2,5,6,7,8}; // values range [-2^16+1..2^16]
